                ...
                <ul class="nav navbar-nav navbar-top-links navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li>
                                <a href="chamaRelatorioGenero.jsp"><i class="fa fa-envelope fa-fw"></i> Relatorio Genero</a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="data-table-generos">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                ArrayList lista = GeneroDB.getListaGeneros(conexao);
                                                for (int i = 0; i < lista.size(); i++) {
                                                    Genero genero = (Genero) lista.get(i);
                                                    ...
                                                    out.println("<a href='javascript:excluirGenero(" + genero.getCodigo() + ")'><i class='fa fa-trash fa-fw' style='font-size: 20px;'></i></a>");
                                                    out.println("<a href='javascript:chamaAlterarGenero(" + genero.getCodigo() + ", \"" + genero.getNome() + "\")'><i class='fa fa-file-text-o fa-fw' style='font-size: 20px;'></i></a>");
                                                    out.println("</td>");
                                                    out.println("</tr>");
                                                }
                                            %>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="ContainerLabelIncluir">Novo Gênero</h4>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="incluirGenero()"i>Incluir</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal fade" id="ContainerAlterar" tabindex="-1" role="dialog" aria-labelledby="ContainerLabelAlterar" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="ContainerLabelAlterar">Alterar Gênero</h4>
                                    </div>
                                    <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary" data-dismiss="modal" id="close-modal-genero">Cancelar</button>
                                        <button type="button" class="btn btn-primary" onclick="alterarGenero()"i>Alterar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
